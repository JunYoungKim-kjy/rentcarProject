...
//	public UserVO(int no,String name, String id, String pw, String email, String tel, String hobby, String job, String age,
//			String info) {
//		super();
//		this.no = no;
//		this.name = name;
...
//	}
	public UserVO() {}
	public UserVO(int no, String id, String pw, String email, String tel, String hobby, String job, String age,
			String info) {
		super();
		this.no = no;
		this.id = id;
